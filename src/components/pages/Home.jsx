...
//               />
//               <div className="p-4">
//                 <h3 className="font-bold text-xl bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 text-transparent bg-clip-text">
//                   {product.productName}
//                 </h3>
...
//                     className="py-2 px-4 rounded-md bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white hover:from-pink-500 hover:to-blue-500 disabled:opacity-50"
//                   >
//                     👍 {product.upvotes}
//                   </button>
//                   <button
//                     onClick={() => navigate(`/products/${product._id}`)}
//                     className="py-2 px-4 rounded-md bg-gradient-to-r from-green-500 to-teal-400 text-white hover:from-teal-400 hover:to-green-500"
//                   >
//                     View Details
//                   </button>
//                 </div>
...
//             className="bg-gradient-to-r from-purple-600 to-blue-500 text-white py-2 px-6 rounded-full hover:from-blue-500 hover:to-purple-600"
//           >
//             Show All Products
//           </button>
//         </div>
