...
const ProductDetails = () => {
  ...
  const statusStyles = {
    Accepted: "text-green-600 bg-green-100 px-3 py-1 rounded-full",
    Rejected: "text-red-600 bg-red-100 px-3 py-1 rounded-full",
    Pending: "text-yellow-600 bg-yellow-100 px-3 py-1 rounded-full",
  };

  return (
    <div className="max-w-5xl mx-auto p-8 bg-gray-50 rounded-lg shadow-md mt-10">
      <h1 className="text-3xl font-bold text-gray-800 text-center mb-8">
        Product Details
      </h1>
      {/* Main Details */}
      <div className="space-y-6 bg-white p-6 rounded-lg shadow-lg">
        {product.productImage && (
          <div className="w-full flex justify-center mb-6 border-4">
            <img
